...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(PegawaiController::class)->middleware('cek_login:pegawai.index')->group(function () {
        ...
        Route::get('/pegawai/delete/{id}', 'delete');
    ...
    Route::controller(JenisPekerjaanController::class)->middleware('cek_login:jenis_pekerjaan.index')->group(function () {
        Route::get('/jenis_pekerjaan', 'index')->name('jenis_pekerjaan.index');
        Route::get('/jenis_pekerjaan/sync', 'sync');
        Route::post('/jenis_pekerjaan/store', 'store');
        Route::post('/jenis_pekerjaan/update', 'update');
        Route::get('/jenis_pekerjaan/edit/{id}', 'edit');
        Route::get('/jenis_pekerjaan/delete/{id}', 'delete');
    });
