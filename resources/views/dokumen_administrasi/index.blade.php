                        ...
                        <table class="table" id="table-1">
                            <thead>
                                <tr>
                                    ...
                                    <th>No Dok Tek</th>
                                    <th>Perihal Dok Tek</th>
                                    <th>Tanggal Dok Tek</th>
                                    <th>Keterangan</th>
                                    <th>#</th>
                                </tr>
                            </thead>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('dok_adm/delete/' . Crypt::encrypt($item->dokumen_administrasi_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="kategori_dokumen_id" id="" class="form-select" required>
                            ...
                            <option value="{{ $item->kategori_dokumen_id }}">{{ $item->keterangan_kategori_dokumen }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
