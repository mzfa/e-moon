                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('surat_menyurat/delete/' . Crypt::encrypt($item->surat_menyurat_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="kategori_surat_id" id="" class="form-select" required>
                            ...
                            <option value="{{ $item->kategori_surat_id }}">{{ $item->keterangan_kategori_surat }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_terima_surat" name="tanggal_terima_surat" required>
                    </div>
                    <div class="mb-3">
