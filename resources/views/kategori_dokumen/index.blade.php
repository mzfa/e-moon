                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('kategori_dokumen/delete/' . Crypt::encrypt($item->kategori_dokumen_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kode_kategori_dokumen" name="kode_kategori_dokumen" required>
                    </div>
                    <div class="mb-3">
                        <label for="staticEmail" class="form-label">Keterangan</label>
                        <input type="text" class="form-control" id="keterangan_kategori_dokumen" name="keterangan_kategori_dokumen" required>
                    </div>
                </div>
