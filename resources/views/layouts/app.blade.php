    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ url('home') }}" class="logo d-flex align-items-center">
                <img src="{{ asset('assets/img/icon.png') }}" alt="" style="">
                <span class="d-none d-lg-block">{{ env('APP_NAME_HCM') }}</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assets/img/messages-1.jpg" alt="" cla') }}ss="rounded-circle">
                                <div>
                                    <h4>Maria Hudson</h4>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assets/img/messages-2.jpg" alt="" cla') }}ss="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>6 hrs. ago</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assets/img/messages-3.jpg" alt="" cla') }}ss="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>8 hrs. ago</p>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ Session('foto_profile') != null ? Session('foto_profile') : 'assets/img/profile-img.jpg' }}"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                onclick="return document.getElementById('logout').submit()">
