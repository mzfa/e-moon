                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('ijin_pelaksanaan/delete/' . Crypt::encrypt($item->ijin_pelaksanaan_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="no_ijin_pelaksanaan" name="no_ijin_pelaksanaan" required>
                    </div>
                    <div class="mb-3">
                        <label for="staticEmail" class="form-label">Perihal Ijin Pelaksanaan</label>
                        <input type="text" class="form-control" id="perihal_ijin_pelaksanaan" name="perihal_ijin_pelaksanaan" required>
                    </div>
                    <div class="mb-3">
                        <label for="staticEmail" class="form-label">Tanggal Dokumen</label>
                        <input type="date" class="form-control" id="tgl_ijin_pelaksanaan" name="tgl_ijin_pelaksanaan" required>
                    </div>
                    <div class="mb-3">
