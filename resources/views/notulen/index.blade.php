                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Apakah anda yakin ini akan di hapus?')" href="{{ url('notulen/delete/' . Crypt::encrypt($item->notulen_id)) }}" class="btn text-white btn-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="tanggal_mulai_rapat" name="tanggal_mulai_rapat" required>
                    </div>
                    <div class="mb-3">
                        <label for="staticEmail" class="form-label">Waktu Selesai</label>
                        <input type="datetime-local" class="form-control" id="tanggal_selesai_rapat" name="tanggal_selesai_rapat" required>
                    </div>
                    <div class="mb-3">
